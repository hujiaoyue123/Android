package com.boxin.ijkplayer.utils;
    ...
    public static int getResourceIdByName(Context context, String className, String name) {
        ...
        if (context == null) {
            ...
            try {
                ...
                Log.d("boxin", "ClassNotFoundException: class=" + className + " fieldname=" + name);
            } catch (IllegalArgumentException var8) {
                Log.d("boxin", "IllegalArgumentException: class=" + className + " fieldname=" + name);
            } catch (SecurityException var9) {
                Log.d("boxin", "SecurityException: class=" + className + " fieldname=" + name);
            } catch (IllegalAccessException var101) {
                Log.d("boxin", "IllegalAccessException: class=" + className + " fieldname=" + name);
            } catch (NoSuchFieldException var11) {
                Log.d("boxin", "NoSuchFieldException: class=" + className + " fieldname=" + name);
            }
